...
describe('CarService Suite Tests', () => {
    ...
    it('shoudl choose the first id from carIds in carCategory', () => {
        const carCategory = mocks.validCarCategory, carIdIndex = 0
    ...
    it('given a carCategory, customer and numberOfDays it should calculate final amount in real', () => {
        ...
        // { age: 50, tax: 1.3, categoryPrice: 37.6, numberOfDays: 5 }
        // (37.6 * 1.3) * 5 = 244.40
    ...
    it('given a customer and a car category it should return a transaction receipt', async () => {
        ...
        // { age: 20, tax: 1.1, categoryPrice: 37.6, numberOfDays = 5 }
        // (37.6 * 1.1) * 5 = 206.8
        sandbox.stub(carService.carRepository, carService.carRepository.find.name).resolves(car)
